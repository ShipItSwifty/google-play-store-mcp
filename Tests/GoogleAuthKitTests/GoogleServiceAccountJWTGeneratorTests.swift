...
@Suite("GoogleServiceAccountJWTGenerator")
struct GoogleServiceAccountJWTGeneratorTests {
...
// credential, and exists only to drive `GoogleServiceAccountJWTGenerator` through the
...
private func decodeBase64URLJSON(_ base64url: String) throws -> [String: Any] {
    guard let data = base64URLDecode(base64url),
        ...
        throw GoogleJWTTestError.invalidJWTPart
    }
    return json
}
...
private enum GoogleJWTTestError: Error {
    case invalidJWTPart
}
